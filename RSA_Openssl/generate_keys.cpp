...
bool generate_keys(const std::string& private_key_file, const std::string& public_key_file) {
    ...
    // Create the context for RSA key generation.
    ...
    // Initializes the context for the key generation.
    ...
    // Setting RSA key size as 2048 bits
    ...
    // Generate the RSA key pair and stores them.
    EVP_PKEY *pkey = NULL;
